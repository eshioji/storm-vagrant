...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  if(!File.exist?(STORM_ARCHIVE))
    `wget -N http://mirror.gopotato.co.uk/apache/storm/apache-storm-0.9.3/apache-storm-0.9.3.zip`
  end
  
  config.vm.define "zookeeper" do |zookeeper|
    zookeeper.vm.box = "ubuntu/precise64"
  ...
  config.vm.define "nimbus" do |nimbus|
    nimbus.vm.box = "ubuntu/precise64"
  ...
  config.vm.define "supervisor1" do |supervisor|
    supervisor.vm.box = "ubuntu/precise64"
  ...
  #config.vm.box_url = "http://files.vagrantup.com/ubuntu/precise64.box"
  ...
  # the file ubuntu/precise64.pp in the manifests_path directory.
  #
